...
trData = horzcat(trLabels, getHogs(trEdges, imDim));
...
saveas(gcf, strcat('reportData/rocCurves/EDGE_SVM - Fixed Partition ROC Curve.png'));
...
writetable(tbl,'reportData/evaluationResults/edge_svm_fixed_partition','Delimiter',',', 'WriteRowNames', true);
...
writetable(tbl, 'reportData/evaluationResults/rawResults/edge_svm_fixed_partition_raw', 'Delimiter', ',', 'WriteRowNames', true);